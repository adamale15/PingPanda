  ...
  return (
    <div className="w-full flex items-start justify-start">
      ...
      <div className="w-full max-w-xl">
        ...
        <div className="bg-[#2f3136] text-sm w-full rounded p-3 mb-3 mt-1.5">
          <div className="flex flex-row sm:flex-row items-center justify-between mb-2">
            {badgeText ? (
              <span
                className={cn(
                  "inline-flex order-2 items-center rounded-md px-2 py-2 text-xs font-medium ring-1 ring-inset ",
