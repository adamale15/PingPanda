        ...
        <div className="p-4">
          <div className="flex items-center bg-[#40444b] rounded-lg p-1">
            ...
            <div className="flex items-center space-x-3 mx-3 text-[#b9bbbe]">
              <Gift className="size-6 hover:text-white cursor-not-allowed hidden sm:block" />
              <Sticker className="size-6 hover:text-white cursor-not-allowed hidden sm:block" />
              <Smile className="size-6 hover:text-white cursor-not-allowed hidden sm:block" />
            </div>
          </div>
        </div>
      </div>
